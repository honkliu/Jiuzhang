...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'chat.command.desc.w': 'List real participants in this chat (excluding Assistant)',
    'chat.command.desc.wa': 'List active (online) real participants (excluding Assistant)',
    ...
    'admin.status': 'Status',
    'admin.date': 'Date',
    'admin.empty': 'No registration requests',
    'admin.pending': 'Pending',
    'admin.registered': 'Registered',
    'admin.loadFailed': 'Failed to load registration requests',
    'chat.room.file': 'File',
  ...
  zh: {
    ...
    'auth.forgot.send': '发送重置码',
    'auth.forgot.remembered': '想起密码了？',
    'auth.forgot.codeRequired': '请输入 6 位验证码',
    'auth.forgot.resetFailed': '重置密码失败',
    'auth.forgot.sendFailed': '发送重置码失败',
    'auth.forgot.verifyInfo': '重置码已发送到',
    'auth.forgot.resetCode': '重置码',
    ...
    'chat.command.desc.w': '列出本聊天的真实参与者（不含助手）',
    'chat.command.desc.wa': '列出当前在线的真实参与者（不含助手）',
