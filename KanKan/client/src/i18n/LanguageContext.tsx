...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'common.save': 'Save',
    'common.searchUsers': 'Search users by name or email...',
    ...
    'auth.register.verifyInfo': 'We sent a 6-digit code to',
  ...
  zh: {
    ...
    'auth.register.verifyInfo': '验证码已发送到',
